    ...
    Alpine.data('thesisTopicData', () => ({
        topics: [
            ...
            },
            {
                ...
                description: "Creating mobile applications for iOS and Android platforms using native and hybrid frameworks."
            },
            {
                id: 7,
                title: "Cybersecurity",
                instructor: "Prof. Brown",
                description: "Protecting computer systems and networks from cyber attacks through security protocols and practices."
            },
            {
                id: 8,
                title: "Cloud Computing",
                instructor: "Dr. Taylor",
                description: "Exploring cloud-based technologies for scalable and flexible computing resources."
            },
            {
                id: 9,
                title: "Blockchain Technology",
                instructor: "Prof. Martinez",
                description: "Understanding the fundamentals of blockchain and its applications in various industries."
            },
            {
                id: 10,
                title: "Internet of Things (IoT)",
                instructor: "Dr. Lee",
                description: "Integration of devices, sensors, and software for interconnected IoT ecosystems."
            }
        ],
